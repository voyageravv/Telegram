...
import org.telegram.gif.GifDecoder;
...
public class AnimatedGifDrawable extends AnimationDrawable {
    ...
    public AnimatedGifDrawable(InputStream source, UpdateListener listener) {
        ...
        for (int i = 0; i < decoder.getFrameCount(); i++) {
            ...
            drawable.setBounds(0, 0, bitmap.getWidth()*3/2, bitmap.getHeight()*3/2);
            addFrame(drawable, decoder.getDelay(i));
            if (i == 0) {
                // Also set the bounds for this container drawable

                setBounds(0, 0, bitmap.getWidth()*3/2, bitmap.getHeight()*3/2);
            }
        }
    }
